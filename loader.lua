...
local NotiFrame = Instance.new("Frame")
	...
	DiscordLib:Notification("Th�ng B�o" , "Welcome to Godx� Hub" , 6 ,16761490896 )
	DiscordLib:Notification("Th�ng B�o" , "V�o Discord Godx� Hub � Nhn Th�ng B�o Cp Nht" , 6 ,16761490896 )
...
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/obfalchx/Godx-Hub/main/icon.txt')))()
local Window = OrionLib:MakeWindow({Name = "Godx Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "Godx"})
